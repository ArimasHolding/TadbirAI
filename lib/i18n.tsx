...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "pdf.section3_text": "قاعدة العملاء النشطة: {clientsCount} عميل مسجل. العميل الرئيسي {topClient} حقق {topClientRev}.",
    "pdf.concentration_title": "⚠️ تركيز الإيرادات:",
    "pdf.concentration_text": "أكبر 3 عملاء يمثلون {top3Pct}% من إجمالي المبيعات خلال هذه الفترة.",
    "pdf.recovery_title": "✔ المستحقات والديون:",
    "pdf.recovery_text": "نسبة التحصيل بلغت {tauxRecouvrement}%. المستحقات المعلقة تبلغ {creancesAttente}.",
    "pdf.section4_title": "4. الملخص الضريبي وتقدير الضريبة",
    "pdf.sales_ht": "إجمالي المبيعات دون الضريبة",
    "pdf.vat_collected": "الضريبة المحصلة على المبيعات (20%)",
    "pdf.net_vat_due": "صافي الضريبة التقديرية الواجبة الدفع (DGI)",
    "pdf.section5_title": "5. توصيات الذكاء الاصطناعي الاستراتيجية",
    "pdf.rec1": "متابعة المستحقات المعلقة: إعطاء الأولوية لتحصيل {creances} المتأخرة حالياً.",
    "pdf.rec2": "ادخار مخصصات ضريبة القيمة المضافة: الاحتفاظ بـ {vat} لسداد التزامات الضريبة.",
    "pdf.rec3": "تقليل مخاطر الاعتماد على العملاء: توسيع قاعدة الحسابات لتقليل نسبة التمركز لدى كبار العملاء الثلاثة ({top3Pct}%).",
    "pdf.generated_by": "تم إنشاء هذا المستند تلقائياً بواسطة تطبيق Tadbir AI Pro.",
    "pdf.certified": "معتمد ومطابق لسجلات الفواتير الداخلية.",
    "pdf.signature_label": "تأشيرة الإدارة المالية:",
    "pdf.stamp_label": "[ ختم إلكتروني صريح وموثق ]",
    "reports.chart.monthly_evolution": "التطور الشهري للإيرادات (درهم)",
    "reports.chart.monthly_subtitle": "مقارنة التحصيلات المسجلة شهرياً",
    "reports.chart.category_split": "حصة الإيرادات حسب فئة الخدمات",
    "reports.chart.category_subtitle": "توزيع المبيعات",
    "reports.table1.title": "جدول الأداء الشهري والتدقيق",
    "reports.table1.subtitle": "تفاصيل الفواتير الصادرة وأحجام المبيعات ومتوسط السلة",
    "reports.table1.export": "تصدير هذا الجدول",
    "reports.table1.col_month": "الشهر",
    "reports.table1.col_revenue": "الإيراد الإجمالي (درهم)",
    "reports.table1.col_variation": "نسبة التغير",
    "reports.table1.col_invoices": "الفواتير الصادرة",
