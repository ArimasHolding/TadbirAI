...
// Literal phrase mapping for automatic translation of raw text across UI pages
const literalTranslations: Record<Language, Record<string, string>> = {
  fr: {},
  en: {
    "Aperçu Global": "Dashboard Overview",
    ...
    "Trésorerie Actuelle": "Current Cash Flow",
  ...
  ar: {
    "Aperçu Global": "نظرة عامة على لوحة التحكم",
    ...
    "Avoirs": "شعارات الخصم",
    "Clients": "العملاء",
    "Bons Cde": "طلبات الشراء",
    "Bons de Commande": "طلبات الشراء",
    "Dépenses": "المصاريف",
    ...
    "Employés": "الموظفون",
    "Équipe": "فريق العمل",
    "Fiches de paie": "كشوف المرتبات",
    "Paramètres": "الإعدادات",
    "WhatsApp Config": "تهيئة الواتساب",
    "Abonnement": "الاشتراك",
    "Mon Entreprise": "شركتي",
    "Modèles": "النماذج",
    "Support": "الدعم الفني",
    "Rapports": "التقارير",
    "Rapports & KPIs": "التقارير والمؤشرات",
    ...
    "Nouveau Bon de Commande": "طلب شراء جديد",
    "Nouveau Employé": "موظف جديد",
    "Ajouter": "إضافة",
    "Modifier": "تعديل",
    "Supprimer": "حذف",
    "Annuler": "إلغاء",
    ...
    "Fournisseur": "المورد",
    "Montant": "المبلغ",
    "Total HT": "المبلغ غير شامل الضريبة",
    "Total TTC": "المبلغ شامل الضريبة",
    "TVA": "الضريبة",
    "Actions": "الإجراءات",
    "Description": "الوصف",
    "Quantité": "الكمية",
    ...
    "Salaire": "الراتب",
    "Poste": "المنصب",
    "Chiffre d'Affaires": "الإيرادات الإجمالية",
    "Factures Impayées": "الفواتير غير المدفوعة",
    "Trésorerie Actuelle": "السيولة النقدية الحالية",
    "Top Clients": "أبرز العملاء",
    "Produits Populaires": "المنتجات الأكثر طلباً",
    "Payée": "مدفوعة",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const t = (key: string, fallback?: string): string => {
    // 1. Direct key match in key dictionary
    const dict = translations[langue] || translations["fr"];
    if (dict && dict[key]) {
      return dict[key];
    }

    // 2. Direct key match in literal phrase dictionary
    const literalDict = literalTranslations[langue];
    if (literalDict && literalDict[key]) {
      return literalDict[key];
    }

    // 3. Fallback string match in literal phrase dictionary
    if (fallback && literalDict && literalDict[fallback]) {
      return literalDict[fallback];
    }

    // 4. French key dictionary fallback
