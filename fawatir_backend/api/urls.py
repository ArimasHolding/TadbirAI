...
router.register(r'avoirs', views.AvoirViewSet)
router.register(r'bons-commande', views.BonCommandeViewSet)
router.register(r'bulletins', views.BulletinPaieViewSet)
...
router.register(r'employes', views.EmployeeViewSet, basename='employe')
